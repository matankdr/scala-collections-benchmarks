...
//    (List[Int]() /: elements) (_ :+ _)
    elements.foldLeft(List.empty[Int])(_ :+ _)
  }
...
//    (Vector[Int]() /: elements) (_ :+ _)
    elements.foldLeft(Vector.empty[Int])(_ :+ _)
  }
...
//    (Vector[Int]() /: elements) ((vector, element) => element +: vector)
    elements.foldLeft(Vector.empty[Int]) ((vector, element) => element +: vector)
  }
...
//    (Stack[Int]() /: elements) (_ :+ _)
    elements.foldLeft(Stack.empty[Int]) (_ :+ _)
  }
...
//    val prependedElements = (Stack[Int]() /: elements) ((stack, element) => stack.push(element))
    val prependedElements = elements.foldLeft(Stack.empty[Int]) ((stack, element) => stack.push(element))
    prependedElements.reverse
  }
...
//    (Queue[Int]() /: elements) ((stack, element) => stack.enqueue(element))
    elements.foldLeft(Queue.empty[Int]) ((stack, element) => stack.enqueue(element))
  }
...
//    val prependedElements = (Queue[Int]() /: elements) ((queue, element) => element +: queue)
    val prependedElements = elements.foldLeft(Queue.empty[Int]) ((queue, element) => element +: queue)
    prependedElements.reverse
  }
